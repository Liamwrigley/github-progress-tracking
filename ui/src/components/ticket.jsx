...
export const Ticket = ({ title, bsIcon, icon, children }) => {
    return (
        <div className='min-h-[80px] flex flex-col gap-4 bg-black shadow-sm bg-opacity-20 duration-100 w-full p-4 relative hover:scale-105 hover:shadow-lg /*border-l-2 border-custom-highlight*/'>
